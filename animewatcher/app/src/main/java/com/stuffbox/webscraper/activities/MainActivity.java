...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        playonii_chanSound(preferences);
    ...
    void playonii_chanSound(SharedPreferences preferences)
    {
        if(!(preferences.contains("playonii_chan")))

        {   SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("playonii_chan",1);
            editor.apply();
        }
        if(preferences.getInt("playonii_chan",0)==1)
        {
            final MediaPlayer mediaPlayer= MediaPlayer.create(this,R.raw.onii_chan);
            mediaPlayer.start();
